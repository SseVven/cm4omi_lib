...
namespace IMDA {
	extern Space_Math_LIBRARY_API IMDA_postion_tol_s get_position_tols_s(std::vector<Vector>, std::vector<Vector>);  // 两点集误差
	extern Space_Math_LIBRARY_API IMDA_postion_tol_s get_position_tols_s(std::vector<Point>, std::vector<Point>);  // 两点集误差

	extern Space_Math_LIBRARY_API std::vector<std::vector<double>> pos_set_trans(double*, int);  // 点集转换
